		...
		private void GetPos(ref Vector3 _PosBuffer)
		{
			switch (m_PosType)
			{
				case PositionType.SCREEN:
					_PosBuffer.Set (UnityEngine.Input.mousePosition.x, UnityEngine.Input.mousePosition.y, 0.0f);
					break;

				case PositionType.SCREEN_PERCENT:
					_PosBuffer.Set (UnityEngine.Input.mousePosition.x / Screen.width, UnityEngine.Input.mousePosition.y / Screen.height, 0.0f);
					break;

				case PositionType.WORLD:
					_PosBuffer.Set (UnityEngine.Input.mousePosition.x, UnityEngine.Input.mousePosition.y, GetDepth ());
