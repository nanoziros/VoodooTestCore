...
namespace Installers
{
    ...
    {
        [SerializeField] private FeatureFlagsConfig m_FeatureFlagsConfig;
        ...
        {
            Container.BindInterfacesAndSelfTo<FeatureFlagService>().FromSubContainerResolve().ByMethod(InstallFeatureFlagManager).AsSingle();
        ...
        private void InstallFeatureFlagManager(DiContainer subContainer)
        {
            subContainer.Bind<FeatureFlagService>().AsSingle();
            subContainer.Bind<FeatureFlagsConfig>().FromInstance(m_FeatureFlagsConfig).AsSingle();
        }
